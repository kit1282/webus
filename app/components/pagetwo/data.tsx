        ...
        <div className="hidden sm:block mt-[100px] ml-[80px]">
            ...
            <div className="grid grid-cols-3 mt-[70px] gap-[80px]">
                <div className=" w-[383px] h-[170px] border-t border-black ">
                    ...
                    <h2 className="text-[22px] leading-[22px] font-light mt-2">
                    average increase in user task completion rates
                    </h2>
                    <p className="text-[16px] leading-[25px] font-light mt-3">
                ...
                <div className=" w-[383px] h-[170px] border-t border-black">
                    ...
                    <h2 className="text-[22px] leading-[22px] font-light mt-2">
                    of projects completed using our full 8-step process
                    </h2>
                    <p className="text-[16px] leading-[25px] font-light mt-3">
                ...
                <div className=" w-[383px] h-[170px] border-t border-black">
                    ...
                    <h2 className="text-[22px] leading-[22px] font-light mt-2">
                    user testing sessions conducted annually
                    </h2>
                    <p className="text-[16px] leading-[25px] font-light mt-3">
                ...
                <div className=" w-[383px] h-[170px] border-t border-black ">
                    ...
                    <h2 className="text-[22px] leading-[22px] font-light mt-2">
                    of clients report improved product clarity post-challenge definition
                    </h2>
                    <p className="text-[16px] leading-[25px] font-light mt-3">
                ...
                <div className=" w-[383px] h-[170px] border-t border-black">
                    ...
                    <h2 className="text-[22px] leading-[22px] font-light mt-2">
                    weeks average time from concept to validated prototype
                    </h2>
                    <p className="text-[16px] leading-[25px] font-light mt-3">
                    weeks average time from concept to validated prototype
                    </p>
