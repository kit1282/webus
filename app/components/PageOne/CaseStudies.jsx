...
export default function CaseStudies() {
  return (
    <div className="flex flex-col gap-[60px] mt-10 sm:mt-0 ml-[30px] sm:ml-[90px] ">
      ...
      <div className="flex sm:flex-row flex-col-reverse gap-[20px] sm:gap-[120px] ">
      ...
      <a href="">
        <div className="hidden sm:block sm:w-[220px] sm:h-[47px] sm:pt-2.5 sm:pr-3 sm:pb-2.5 sm:pl-3p sm:gap-2.5 sm:border sm:border-black sm:ml-[1040px] sm:-mt-10">
