...
export default function Accord() {
  ...
  return (
    <div className="px-24 relative">
      <Accordion open={open === 1} >
        <AccordionHeader onClick={() => handleOpen(1)}>
          UI design
          <GoPlus  className={`ml-[1100px] text-red-600 ${ open === 1 ? "rotate-45 ": "rotate-0" } `}/>
        </AccordionHeader>
        <AccordionBody>
      ...
      <Accordion open={open === 2}>
        <AccordionHeader onClick={() => handleOpen(2)}>
          Prototyping
          <GoPlus  className={`ml-[1075px] text-red-600 ${ open === 2 ? "rotate-45 ": "rotate-0" } `}/>
        </AccordionHeader>
        <AccordionBody>
          {/* Use the Features component with the first set of data */}
      ...
      <Accordion open={open === 3}>
        <AccordionHeader onClick={() => handleOpen(3)}>
          ...
          <GoPlus  className={`ml-[960px] text-red-600 ${ open === 3 ? "rotate-45 ": "rotate-0" } `}/>
        </AccordionHeader>
        <AccordionBody>
      ...
      <Accordion open={open === 4}>
        <AccordionHeader onClick={() => handleOpen(4)}>
          Design Systems
          <GoPlus  className={`ml-[1030px] text-red-600 ${ open === 4 ? "rotate-45 ": "rotate-0" } `}/>
        </AccordionHeader>
        <AccordionBody>
      ...
      <Accordion open={open === 5}>
        <AccordionHeader onClick={() => handleOpen(5)}>
          ...
          <GoPlus  className={`ml-[950px] text-red-600 ${ open === 5 ? "rotate-45 ": "rotate-0" } `}/>
        </AccordionHeader>
        <AccordionBody>
          {/* Use the Features component with the third set of data */}
      ...
      <Accordion open={open === 6}>
        <AccordionHeader onClick={() => handleOpen(6)}>
          User Testing
          <GoPlus  className={`ml-[1060px] text-red-600 ${ open === 6 ? "rotate-45 ": "rotate-0" } `}/>
        </AccordionHeader>
        <AccordionBody>
          {/* Use the Features component with the third set of data */}
    ...
    <Image src="/image/18.png" alt="bg" width={440} height={235} className="absolute -inset-x-[100px] inset-y-[460px] w-[240px] h-[340px]"/>
