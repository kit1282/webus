...
const Features = ({ title, description, sections }) => {
  return (
    <div>
      <div className="flex flex-col sm:flex-row  w-[330px] sm:gap-[00px] h-[750px] sm:h-[360px]  sm:mt-5 sm:ml-4 sm:pt-0 sm:pb-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-[90px] mt-5 sm:gap-x-[370px] sm:ml-[300px] ">
